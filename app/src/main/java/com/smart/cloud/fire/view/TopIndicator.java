...
public class TopIndicator extends RelativeLayout {
    ...
    private int[] mDrawableIds = new int[] { R.drawable.yg_dh_tb_all,R.drawable.yg_dh_tb_dq, R.drawable.yg_dh_tb_lx};
    ...
    // 顶部菜单的文字数组
    private CharSequence[] mLabels = new CharSequence[] { "智慧消防", "智慧用电", "离线设备"};
