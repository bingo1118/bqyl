...
public class ShopInfoFragmentPresenter extends BasePresenter<ShopInfoFragmentView> {
    ...
    public void getSmokeSummary(String userId,String privilege,String areaId,String devType){
        Observable mObservable = apiStores1.getSmokeSummary(userId,privilege,areaId,devType);
