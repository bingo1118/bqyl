...
public class ElectricActivityAdapterTest extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (electricType) {
            case 6:
                ...
                try{
                    if (value.length() > 0) {
                        ...
                        ((ItemViewHolder) holder).electricName.setText("电压"+num2Eng(ElectricOne));
                        ...
                        if (Double.parseDouble(value) - Double.parseDouble(electricThresholdTwo) > 0) {
                            ...
                            ((ItemViewHolder) holder).electricStates.setText("过压");
            ...
            case 7:
                ...
                if (value7.length() > 0) {
                    ...
                    try{
                        ...
                        ((ItemViewHolder) holder).tvImage.setVisibility(View.VISIBLE);
                        ((ItemViewHolder) holder).electricLin.setVisibility(View.VISIBLE);
                        ((ItemViewHolder) holder).electricName.setText("电流"+num2Eng(ElectricTwo));
            ...
            case 8:
                ...
                String a=electric.getElectricThreshold();
                try{
                    if (value8.length() > 0) {
                        double electricThreshold = Double.parseDouble(electric.getElectricThreshold());
                        ((ItemViewHolder) holder).tvImage.setVisibility(View.VISIBLE);
            ...
            case 9:
                ...
                try{
                    if (value97.length() > 0) {
                        ...
                        ((ItemViewHolder) holder).tvImage.setVisibility(View.VISIBLE);
                        ((ItemViewHolder) holder).electricLin.setVisibility(View.VISIBLE);
                        ((ItemViewHolder) holder).electricName.setText("温度"+num2Eng(ElectricFour));
    ...
    //@@7.15 数字转换为字母
    private String num2Eng(int electricOne) {
        String temp="";
        String[] engs={"A","B","C","D","E","F","G"};
        if(electricOne<=engs.length){
            return engs[electricOne-1];
        }else{
            return temp;
        }
    }
